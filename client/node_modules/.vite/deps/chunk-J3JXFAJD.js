...
var name = "fluidRenderingStandardBlurPixelShader";
var shader = `uniform sampler2D textureSampler;uniform int filterSize;uniform vec2 blurDir;varying vec2 vUV;void main(void) {vec4 s=textureLod(textureSampler,vUV,0.);if (s.r==0.) {glFragColor=vec4(0.,0.,0.,1.);return;}
...
var fluidRenderingStandardBlurPixelShader = { name, shader };

export {
  fluidRenderingStandardBlurPixelShader
};
//# sourceMappingURL=chunk-J3JXFAJD.js.map
