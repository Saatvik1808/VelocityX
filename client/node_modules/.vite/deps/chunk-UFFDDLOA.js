...
import {
  RGBDTextureTools
} from "./chunk-L7EZAJHM.js";
import {
  Node
} from "./chunk-7OBJKRBM.js";
import {
...
import {
  UniformBuffer
} from "./chunk-SIWBGISN.js";
import {
  Axis
} from "./chunk-YYFIVFKX.js";
import {
  Frustum,
  SmartArray
...
import {
  ErrorCodes,
  RuntimeError
} from "./chunk-WOC7UFRT.js";
import {
  WebRequest
} from "./chunk-D7EI5OWC.js";
import {
  GetClass,
  RegisterClass
...
var AbstractMesh = class _AbstractMesh extends TransformNode {
  ...
  async optimizeIndicesAsync() {
    ...
    const { OptimizeIndices } = await import("./mesh.vertexData.functions-3DFO5WPV.js");
      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-7YGKFYDN.js"), import("./default.fragment-UOPKDZBT.js")]);
          } else {
            await Promise.all([import("./default.vertex-7FXP6CTX.js"), import("./default.fragment-OGY3G2GF.js")]);
          }
...
var onCreatedEffectParameters3 = { effect: null, subMesh: null };
    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-QBUUUJOB.js"), import("./pbr.fragment-44N2UW6G.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-YQS3GAKL.js"), import("./pbr.fragment-D27O6JIT.js")]);
        }
        this._shadersLoaded = true;
      }
    }, engine);
...
//# sourceMappingURL=chunk-UFFDDLOA.js.map
