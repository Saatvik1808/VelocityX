...
var name5 = "pbrHelperFunctions";
var shader5 = `#define MINIMUMVARIANCE 0.0005
...
var name6 = "pbrDirectLightingSetupFunctions";
var shader6 = `struct preLightingInfo
{lightOffset: vec3f,
...
var name7 = "pbrDirectLightingFalloffFunctions";
var shader7 = `fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
var name8 = "pbrDirectLightingFunctions";
var shader8 = `#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
var name9 = "pbrIBLFunctions";
var shader9 = `#if defined(REFLECTION) || defined(SS_REFRACTION)
...
var name10 = "pbrBlockAlbedoOpacity";
var shader10 = `struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
var name11 = "pbrBlockReflectivity";
var shader11 = `struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
var name12 = "pbrBlockAmbientOcclusion";
var shader12 = `struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
var name13 = "pbrBlockAlphaFresnel";
var shader13 = `#ifdef ALPHAFRESNEL
...
var name14 = "pbrBlockAnisotropic";
var shader14 = `#ifdef ANISOTROPIC
...
var name15 = "pbrBlockReflection";
var shader15 = `#ifdef REFLECTION
...
var name16 = "pbrBlockSheen";
var shader16 = `#ifdef SHEEN
...
var name17 = "pbrBlockClearcoat";
var shader17 = `struct clearcoatOutParams
...
var name18 = "pbrBlockIridescence";
var shader18 = `struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
var name19 = "pbrBlockSubSurface";
var shader19 = `struct subSurfaceOutParams
...
var name20 = "pbrBlockNormalGeometric";
var shader20 = `var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
var name21 = "pbrBlockNormalFinal";
var shader21 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var name22 = "pbrBlockLightmapInit";
var shader22 = `#ifdef LIGHTMAP
...
var name23 = "pbrBlockGeometryInfo";
var shader23 = `var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
var name24 = "pbrBlockReflectance0";
var shader24 = `var reflectance: f32=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);var specularEnvironmentR0: vec3f=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
var name25 = "pbrBlockReflectance";
var shader25 = `#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
var name26 = "pbrBlockDirectLighting";
var shader26 = `var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
var name27 = "pbrBlockFinalLitComponents";
var shader27 = `aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
var name28 = "pbrBlockFinalUnlitComponents";
var shader28 = `var finalDiffuse: vec3f=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
var name29 = "pbrBlockFinalColorComposition";
var shader29 = `var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
var name30 = "pbrBlockImageProcessing";
var shader30 = `#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
var name31 = "pbrBlockPrePass";
var shader31 = `var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
var name33 = "pbrPixelShader";
var shader33 = `#define CUSTOM_FRAGMENT_BEGIN
...
var pbrPixelShaderWGSL = { name: name33, shader: shader33 };

export {
  pbrPixelShaderWGSL
};
//# sourceMappingURL=chunk-FNMXLSUT.js.map
