...
var name = "screenSpaceReflection2BlurPixelShader";
var shader = `var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;uniform texelOffsetScale: vec2f;const weights: array<f32,8>=array<f32,8>(0.071303,0.131514,0.189879,0.321392,0.452906, 0.584419,0.715932,0.847445);fn processSample(uv: vec2f,i: f32,stepSize: vec2f,accumulator: ptr<function,vec4f>,denominator: ptr<function,f32>)
...
var screenSpaceReflection2BlurPixelShaderWGSL = { name, shader };

export {
  screenSpaceReflection2BlurPixelShaderWGSL
};
//# sourceMappingURL=chunk-SQDNVLWN.js.map
