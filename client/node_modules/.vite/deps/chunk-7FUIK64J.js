...
var name = "iblGenerateVoxelMipPixelShader";
var shader = `precision highp float;precision highp sampler3D;varying vec2 vUV;uniform sampler3D srcMip;uniform int layerNum;void main(void) {ivec3 Coords=ivec3(2)*ivec3(gl_FragCoord.x,gl_FragCoord.y,layerNum);uint tex =
...
var iblGenerateVoxelMipPixelShader = { name, shader };

export {
  iblGenerateVoxelMipPixelShader
};
//# sourceMappingURL=chunk-7FUIK64J.js.map
