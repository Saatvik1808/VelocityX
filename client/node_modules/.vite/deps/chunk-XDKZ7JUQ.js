...
var shader8 = `float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
var name11 = "pbrBlockAlbedoOpacity";
var shader11 = `struct albedoOpacityOutParams
...
var name12 = "pbrBlockReflectivity";
var shader12 = `struct reflectivityOutParams
...
var name13 = "pbrBlockAmbientOcclusion";
var shader13 = `struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
var name14 = "pbrBlockAlphaFresnel";
var shader14 = `#ifdef ALPHAFRESNEL
...
var name15 = "pbrBlockAnisotropic";
var shader15 = `#ifdef ANISOTROPIC
...
var name16 = "pbrBlockReflection";
var shader16 = `#ifdef REFLECTION
...
var name17 = "pbrBlockSheen";
var shader17 = `#ifdef SHEEN
...
var name18 = "pbrBlockClearcoat";
var shader18 = `struct clearcoatOutParams
...
var name19 = "pbrBlockIridescence";
var shader19 = `struct iridescenceOutParams
...
var name20 = "pbrBlockSubSurface";
var shader20 = `struct subSurfaceOutParams
...
var name21 = "pbrBlockNormalGeometric";
var shader21 = `vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
var name22 = "pbrBlockNormalFinal";
var shader22 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var name23 = "pbrBlockLightmapInit";
var shader23 = `#ifdef LIGHTMAP
...
var name24 = "pbrBlockGeometryInfo";
var shader24 = `float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
var name25 = "pbrBlockReflectance0";
var shader25 = `float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
var name26 = "pbrBlockReflectance";
var shader26 = `#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
var name27 = "pbrBlockDirectLighting";
var shader27 = `vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
var name28 = "pbrBlockFinalLitComponents";
var shader28 = `aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
var name29 = "pbrBlockFinalUnlitComponents";
var shader29 = `vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
var name30 = "pbrBlockFinalColorComposition";
var shader30 = `vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
var name31 = "pbrBlockImageProcessing";
var shader31 = `#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
var name32 = "pbrBlockPrePass";
var shader32 = `float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
var name34 = "pbrPixelShader";
var shader34 = `#define CUSTOM_FRAGMENT_EXTENSION
...
var pbrPixelShader = { name: name34, shader: shader34 };

export {
  pbrPixelShader
};
//# sourceMappingURL=chunk-XDKZ7JUQ.js.map
