...
import {
  Clamp
} from "./chunk-C75ZATOP.js";
import {
  HasStencilAspect,
  ThinEngine,
  WebGLDataBuffer,
  WebGLHardwareTexture
} from "./chunk-WKNOOF3W.js";
import {
  AbstractEngine,
  Effect,
  FloorPOT,
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-46ALHB7X.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-4GA26YFO.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-U355ZJDL.js")]));
    }
  }
  /**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-O3P6KFAL.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-HMTLPZEV.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-NLDWM4Z6.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-C3MSGPPG.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-LPM7SYRX.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-VBT6DSPI.js");
    } else {
      await import("./lod.fragment-B3PJTYLS.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-3PKCTQ5X.js");
    } else {
      await import("./lod.fragment-5HNZJ5S4.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-PHHETYLE.js.map
