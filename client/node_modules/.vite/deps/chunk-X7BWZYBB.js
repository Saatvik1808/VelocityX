...
var name = "fluidRenderingBilateralBlurPixelShader";
var shader = `uniform sampler2D textureSampler;uniform int maxFilterSize;uniform vec2 blurDir;uniform float projectedParticleConstant;uniform float depthThreshold;varying vec2 vUV;void main(void) {float depth=textureLod(textureSampler,vUV,0.).x;if (depth>=1e6 || depth<=0.) {glFragColor=vec4(vec3(depth),1.);return;}
...
var fluidRenderingBilateralBlurPixelShader = { name, shader };

export {
  fluidRenderingBilateralBlurPixelShader
};
//# sourceMappingURL=chunk-X7BWZYBB.js.map
